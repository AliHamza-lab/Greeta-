...
class ChatBot:
    ...
    def generate_audio(text, lang='ENG'):
        ...
        url = 'https://api.bland.ai/v1/voices/e1289219-0ea2-4f22-a994-c542c2a48a0f/sample'
        headers = {
        ...
        # Debug print to inspect the request payload
        ...
        if response.status_code == 200:
            ...
            print(f"Failed to generate audio for: {text}. Status code: {response.status_code}, Response: {response.text}")
            return None
